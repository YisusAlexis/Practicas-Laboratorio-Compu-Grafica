...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		// CABINA (nodo padre)
		model = glm::translate(model, glm::vec3(0.0f, 4.0f, -4.0f)); //origen de la cabina
		modelaux = model;
		modelaux2 = model;
		model = glm::scale(model, glm::vec3(5.0f, 4.0f, 4.0f)); //escalar cubo (cabina)
		...
		model = modelaux2; //volver a cabina
		...
		// ARTICULACIÓN 1 (para unir a la cabina y brazo 1)
		model = glm::translate(model, glm::vec3(0.0f, 4.0f, 0.0f)); //posición sobre la cabina
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion1()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model; //guardar punto de articulación 1
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f)); //esfera pequeña
		...
		model = modelaux; //descarta escala de la articulacion

		
		//BRAZO 1	
		//rotación del brazo desde la articulación
		model = glm::rotate(model, glm::radians(135.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::translate(model, glm::vec3(2.5f, 0.0f, 0.0f));
		modelaux = model;//guardamos traslacion y rotaciones del brazo para heredar a la siguiente articulación
		model = glm::scale(model, glm::vec3(5.0f, 1.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 0.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMesh(); //dibuja cubo escalado para el brazo1

		model = modelaux; //descarta escalado del brazo para que no afecte a las siguientes articulaciones ni al brazo 2
		
		//ARTICULACION 2 (unira a brazo1 y brazo 2)
		model = glm::translate(model, glm::vec3(2.5f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;//guardamos la traslacion de la articulacion 2 para heredar al brazo 2
		//dibujar una pequeña esfera
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.5f, 0.5f, 0.5f); //gris como un balero	
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		sp.render();

		model = modelaux; //Decartamos traslacion de la articulacion 2 para que no afecte a las siguientes articulaciones ni al brazo 2
		...
		//ARTICULACION 3 (une brazo 2 y brazo 3)
		model = glm::translate(model, glm::vec3(0.0f, -2.5f, 0.0f));
		...
		//ARTICULACION 4 (une brazo 3 con la canastilla)
		model = glm::translate(model, glm::vec3(0.0f, -2.5f, 0.0f));
