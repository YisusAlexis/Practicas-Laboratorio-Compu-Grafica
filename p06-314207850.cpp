...
// average normals
	...
	GLfloat octaedro_vertices[] = {
		...
		//x      y      z      S     T     NX    NY    NZ
		 0.0f,  1.0f,  0.0f,  0.29f,  0.74f,  0.0f,  0.0f,  0.0f,  // Vértice superior
		 1.0f,  0.0f,  0.0f,  0.43f,  0.5f,  0.0f,  0.0f,  0.0f,  // Vértice derecho
		 0.0f,  0.0f,  1.0f,  0.15f,  0.5f,  0.0f,  0.0f,  0.0f,  // Vértice frontal

		 // Cara 2 (superior izquierda) - Triángulo 2
		  0.0f,  1.0f,  0.0f,  0.01f,  0.74f,  0.0f,  0.0f,  0.0f,  // Vértice superior
		  0.0f,  0.0f,  1.0f,  0.29f,  0.74f,  0.0f,  0.0f,  0.0f,  // Vértice frontal
		 -1.0f,  0.0f,  0.01f,  0.15f,  0.5f,  0.0f,  0.0f,  0.0f,  // Vértice izquierdo

		 // Cara 3 (superior posterior) - Triángulo 3
		   0.0f,  1.0f,  0.0f,  0.44f,  0.99f,  0.0f,  0.0f,  0.0f,  // Vértice superior
		  -1.0f,  0.0f,  0.0f,  0.58f,  0.74f,  0.0f,  0.0f,  0.0f,  // Vértice izquierdo
		   0.0f,  0.0f, -1.0f,  0.29f,  0.74f,  0.0f,  0.0f,  0.0f,  // Vértice posterior

		  // Cara 4 (superior derecho) - Triángulo 4
		   0.0f,  1.0f,  0.0f,  0.58f,  0.74f,  0.0f,  0.0f,  0.0f,  // Vértice superior
		   0.0f,  0.0f, -1.0f,  0.43f,  0.5f,  0.0f,  0.0f,  0.0f,  // Vértice posterior
		   1.0f,  0.0f,  0.0f,  0.29f,  0.74f,  0.0f,  0.0f,  0.0f,  // Vértice derecho



		   // Cara 5 (inferior frontal) - Triángulo 5
			0.0f, -1.0f,  0.0f,  0.29f,  0.26f,   0.0f,  0.0f,  0.0f,  // Vértice inferior
			0.0f,  0.0f,  1.0f,  0.15f,  0.5f,  0.0f,  0.0f,  0.0f,  // Vértice frontal
			1.0f,  0.0f,  0.0f,  0.43f,  0.5f,   0.0f,  0.0f,  0.0f,  // Vértice derecho

			// Cara 6 (inferior izquierdo) - Triángulo 6
			 0.0f, -1.0f,  0.0f,  0.01f,  0.25f,  0.0f,  0.0f,  0.0f,  // Vértice inferior
			-1.0f,  0.0f,  0.0f,  0.29f,  0.26f, 0.0f,  0.0f,  0.0f,  // Vértice izquierdo
			 0.0f,  0.0f,  1.0f,  0.15f,  0.5f,   0.0f,  0.0f,  0.0f,  // Vértice frontal

			 // Cara 7 (inferior posterior) - Triángulo 7
			  0.0f, -1.0f,  0.0f,  0.44f,  0.01f,  0.0f,  0.0f,  0.0f,  // Vértice inferior
			  0.0f,  0.0f, -1.0f,  0.29f,  0.26f,  0.0f,  0.0f,  0.0f,  // Vértice posterior
			 -1.0f,  0.0f,  0.0f,  0.58f,  0.25f,  0.0f,  0.0f,  0.0f,  // Vértice izquierdo

			 // Cara 8 (inferior deredcho) - Triángulo 8
			  0.0f, -1.0f,  0.0f,  0.58f,  0.25f,  0.0f,  0.0f,  0.0f,  // Vértice inferior
			  1.0f,  0.0f,  0.0f,  0.29f,  0.26f,  0.0f,  0.0f,  0.0f,  // Vértice derecho
			  0.0f,  0.0f, -1.0f,  0.43f,  0.5f,  0.0f,  0.0f,  0.0f   // Vértice posterior
	};
...
int main()
{
	...
	dadoTextureAnimales = Texture("Textures/dado_animales2.jpeg");
	dadoTextureAnimales.LoadTextureA();
	...
	Dado_M = Model();
	Dado_M.LoadModel("Models/dadoAnimalesBlender.obj");

	elRey_M = Model();
	elRey_M.LoadModel("Models/autoTexturaLlantasElrey.obj");
