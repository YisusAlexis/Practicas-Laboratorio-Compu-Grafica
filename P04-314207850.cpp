/*Practica 04: Modelado Jerárquico.
Se implementa el uso de matrices adicionales para almacenar información de transformaciones geométricas que se quiere
heredar entre diversas instancias para que estén unidas
Teclas de la F a la L y de la T a la P para rotaciones de articulaciones
*/
...
int main()
{
	...
	*/
	camera = Camera(glm::vec3(0.0f, 5.0f, 10.0f), glm::vec3(0.0f, 1.0f, 0.0f), -90.0f, -20.0f, 0.3f, 0.3f);
	...
	while (!mainWindow.getShouldClose())
	{
		...
		color = glm::vec3(0.2f, 0.4f, 0.2f); //verde
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.2f, 0.4f, 0.3f); //verde
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		sp.render();
